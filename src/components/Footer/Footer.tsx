...
const Footer: React.FC = () => {
    return (
        <div className="relative bg-[#e0e0e0] w-full h-[356px] flex justify-between items-center px-16">
            <div className="flex flex-col items-center">
                ...
                <div className="text-[#898989] text-sm mt-6">
            ...
            <div className="flex flex-col w-1/2">
                ...
                <div className="flex gap-8 w-full">
                    <p className="text-sm text-[#000] leading-[1.6] w-1/2">
