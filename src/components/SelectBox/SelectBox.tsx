  ...
  return (
    <div className="relative w-[124px]">
      ...
      <button
        ...
        className="flex w-full items-center justify-between rounded-t-[10px] border border-[#ebc6ff] bg-white py-3 pl-[18px] pr-3 text-base font-medium text-hellopy-purple-200"
      >
        ...
        <ul className="absolute left-0 top-full z-10 w-full rounded-b-[10px] border border-[#ebc6ff] bg-white shadow-md">
          {options.map((option) => (
            <li
              ...
              className="cursor-pointer px-[18px] py-3 text-base font-medium text-hellopy-purple-200 hover:bg-[#f3e8ff]"
            >
              {option.label}
            </li>
          ))}
