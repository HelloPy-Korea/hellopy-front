...
export const HomeCard = ({
   ...
   // const navigate = useNavigate();
    ...
    return (
        <div
            className="relative w-[1600px] h-[626px] bg-cover bg-center bg-[#fbf6ff]"
            ...
            >
                <div className="flex flex-col gap-5">
                    <div className="flex flex-col gap-1">
                        {subtitle &&
									        <span className="text-xl font-semibold text-[#bc1df2] leading-[30px]">{subtitle}</span>}
                ...
                {buttonText && <button
	                className={`py-1.5 border-b border-[#2c003c] text-base font-medium leading-tight 
